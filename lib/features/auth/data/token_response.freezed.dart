...
mixin _$TokenResponse {
  ...
  int get expiresInMillis => throw _privateConstructorUsedError;
...
abstract class $TokenResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, int expiresInMillis});
}
      ...
      _value.copyWith(
            ...
            refreshToken: null == refreshToken
                ...
                : refreshToken // ignore: cast_nullable_to_non_nullable
                      as String,
            expiresInMillis: null == expiresInMillis
                ? _value.expiresInMillis
                : expiresInMillis // ignore: cast_nullable_to_non_nullable
                      as int,
          )
          as $Val,
    );
...
class _$TokenResponseImpl implements _TokenResponse {
  ...
  @override
  String toString() {
    return 'TokenResponse(accessToken: $accessToken, refreshToken: $refreshToken, expiresInMillis: $expiresInMillis)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.expiresInMillis, expiresInMillis) ||
                other.expiresInMillis == expiresInMillis));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiresInMillis);
...
abstract class _TokenResponse implements TokenResponse {
  const factory _TokenResponse({
    ...
    required final int expiresInMillis,
  }) = _$TokenResponseImpl;
